...
//     const res = await fetch("https://sports-camp-server-unqt1ouq2-ahbanna.vercel.app/users");
//     return res.json();
//   });
...
//     fetch(`https://sports-camp-server-unqt1ouq2-ahbanna.vercel.app/users/admin/${user._id}`, {
//       method: "PATCH",
//     })
//       .then((res) => res.json())
//       .then((data) => {
...
const ManageUsers = () => {
  ...
  const { data: users = [], refetch } = useQuery(["users"], async () => {
    const res = await fetch(
      "https://sports-camp-server-unqt1ouq2-ahbanna.vercel.app/users"
    );
    return res.json();
  });
  ...
  const handleMakeRole = (user, role) => {
    fetch(
      `https://sports-camp-server-unqt1ouq2-ahbanna.vercel.app/users/${role}/${user._id}`,
      {
        method: "PATCH",
      }
    )
  ...
  //   if (!user.role) {
  //     fetch(`https://sports-camp-server-unqt1ouq2-ahbanna.vercel.app/users/default-role/${user._id}`, {
  //       method: "PATCH",
  //     })
  //       .then((res) => res.json())
  //       .then((data) => {
